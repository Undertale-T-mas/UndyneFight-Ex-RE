        ...
        class Project : WaveConstructor, IWaveSet
        {
            ...
            public void Extreme()
            {
                ...
                if (InBeat(4 * 16))
                {
                    ...
                    {
                        "*d(<1>RLine)","","*+0","",    "*d1(<-1>RLine)","","*+01","",    "*d(<1>RLine)","","*+0","",    "$11(<-1>RLine)","-11(<1>RLine)","+11","-11",
                        "+11","","$1(<1>RLine)","+1",    "-1(<-1>RLine)","","*+0","",    "*d1(<1>RLine)","","*+01","",    "$2(<-1>RLine)","-1(<1>RLine)","+1","-1",
                        //
                        "+1(<1>RLine)","","*+0","",    "*d1(<-1>RLine)","","*+01","",    "*d(<1>RLine)","","*+0","",    "$01(<-1>RLine)","+11(<1>RLine)","-11","+11",
                        "-11(<-1>RLine)","","*+01","",    "!!8","+01(<2,-45,5,1>Line1)","+01'1.8","+01","+01'1.8","+01","","","",    "!!8","*d","","","","+0(<-3,90,3,1>Line1)","+0'1.8","+0","",    "!!8","+0","","","","*d1(<-2,45,5,-1>Line1)","+01'1.8","+01","+01'1.8",
                        //
                        "+01(<-1>RLine)","","+01","",    "*d(<1>RLine)","","*+0","",    "*d1(<-1>RLine)","","*+01","",    "$1(<1>RLine)","+1(<-1>RLine)","-1","+1",
                        "-1","","$11(<-1>RLine)","-11",    "+11(<1>RLine)","","*+01","",    "*d(<-1>RLine)","","*+0","",    "$21(<1>RLine)","-11(<-1>RLine)","+11","-11",
                        //
