...
namespace Rhythm_Recall.Waves
{
    public partial class MikuFight
    {
        private class MainFight : IWaveSet
        {
            ...
            public void Start()
            {
                InstanceCreate(new DelProgress());
                ...
                (p1.CurrentShader as NeonLineShader).DrawingColor = Color.White * 0.4f;
                (p1.CurrentShader as NeonLineShader).Speed = 0.4f;
                ...
                {
                    var v = p2.CurrentShader as BallShapingShader;
