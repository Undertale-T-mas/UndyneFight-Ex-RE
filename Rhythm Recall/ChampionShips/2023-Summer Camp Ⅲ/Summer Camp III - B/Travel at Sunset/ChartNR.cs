        ...
        public partial class Project
        {
            public void Normal()
            {
                ...
                if (InBeat(206, 232) && At0thBeat(1f))
                {
                    ...
                    for (int i = -1; i < 2; ++i)
                    {
                        CreateEntity(new NormalSpear(new(0, 0), dir + i * 20, 2.1f)
                        {
                            DelayTargeting = false,
                            IsMute = true,
                            Acceleration = 0.015f,
                        });
                        CreateEntity(new NormalSpear(new(640, 0), dir + i * 20 + 90, 2.1f)
                        {
                            DelayTargeting = false,
                            IsMute = true,
                            Acceleration = 0.015f,
                ...
                if (InBeat(72 + 128))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 6.5f, new string[]
                    {
                        ...
                        "(Green)(Box)", "", "", "",    "", "", "", "",      
                        //5
                        "(d1)(+01)(LineL)", "", "", "",    "(d1)(+01)(SCS)(LineL)", "", "d1", "",
                        "d1(LineL)", "", "d1", "",    "(d1)(+01)(SCS)(LineL)", "", "d1", "",
                        "(d1)(+01)(LineL)", "", "d1", "",    "(d1)(+01)(SCS)(LineL)", "", "d1", "",
                        "(d1)(+01)(LineL)", "", "d1", "",    "(d1)(+01)(SCS)(TurnR)", "", "d1", "",    
                        //6
                        "(d)(+0)", "", "", "",    "(d)(+0)(SCS)(LineR)", "", "d", "",
                        "d(LineR)", "", "d", "",    "(d)(+0)(SCS)(LineR)", "", "", "",
                        "(d)(+0)(LineR)", "", "d", "",    "(d)(+0)(SCS)(LineR)", "", "d", "",
                        "(d)(+0)(LineR)", "", "d", "",    "(d)(+0)(SCS)(TurnL)", "", "+0", "",      
                        //7
                        "*^$01'1.6(*^$21'1.6)(Eff1)", "", "", "",    "(d)(+0)(SCS)(SCL)(LineG2)", "", "d", "",
                        "d(LineR)", "", "d", "",    "(d)(+0)(SCS)(SCR)(LineG1)", "", "d", "",
                        "d(LineL)", "", "d", "",    "(d)(+0)(SCS)(SCL)(LineG2)", "", "d", "",
                        "d(LineR)", "", "d", "",    "(d)(+0)(SCS)(SCR)(LineG1)", "", "n3", "",    
                        //8
                        "$3(n31)(SCS-G)", "", "$1", "$1",    "$1", "", "$3", "",
                        "$31", "", "$11", "$11",    "$11", "", "$31", "",
                        "(D)(+01)", "", "(D)(+01)", "",    "(D)(+01)", "", "(D)(+01)", "",
                ...
                if (InBeat(72 + 192))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 7.2f, new string[]
                    {
                        ...
                        "", "", "", "",    "(pre)", "", "", "",    
                        //1
                        "$21(ROTL)", "$21", "$20", "$20",     "$01", "$01", "$00", "$00",
                        "$30", "", "$0", "$00",    "$00", "", "$31", "",
                        "$31(ML)", "", "$1", "$1",    "$1", "", "$11", "$11",
                        "$11", "", "$3", "$3",    "$3", "", "", "",     
                        //2
                        "$11(ROTR)", "", "$31", "",    "$20", "$20", "$01", "$01",
                        "$0", "$0", "$0", "",    "$21", "", "$21", "",
                        "$31(MR)", "", "$2", "$2",    "$2", "", "$01", "",
                        "$01", "", "$0", "$0",    "$0", "", "$11", "",      
                        //3
                        "^$3'1.8(^$31'1.8)(ROTL)", "", "$20", "$20",     "$01", "$01", "$00", "$00",
                        "$00", "", "$21", "$21",    "$21", "", "$0", "",
                        "$0(ML)", "", "$01", "$01",    "$01", "", "$2", "$2",
                        "$2", "", "$21", "$21",    "$01", "", "", "",      
                        //4      
                        ...
                        "$31(SCS)(LineL)", "", "$11", "$11",    "$11", "", "$31", "$31",
                        "$31(SCS)(LineL)", "", "", "",    
                        //6
                        "$31(SCL)", "", "$11", "",    "$31(SCS)(LineR)", "$31", "$11", "$11",
                        "$2(SCR)", "$2", "$2", "",    "$0(SCS)(LineR)", "", "$2", "",
                        "$0(SCL)", "", "$2", "$2",    "$2(SCS)(LineR)", "", "$31", "",
                        "$31(SCR)", "", "$11", "$11(changeEase)",    "$11(SCS)(LineR)", "", "$0", "",      
                        //7
                        "^$3'1.8(^$31'1.8)(SCL)", "", "$11(SCS)(LineL)", "",    "$0", "$00", "$1", "$1",
                        "$2(SCR)", "", "$21", "$21",    "$21(SCS)(LineL)", "", "$01", "",
                        "$21(SCL)", "", "$0", "$0",    "$0(SCS)(LineL)", "", "$2", "$2",
                        "$2(SCR)", "", "$0", "$0",    "$0(SCS)", "", "", "",    
                        //8
                        "$20'1.2($00'1.2)(SCL2)", "", "$31'1.1(SCR2)", "$31'1.1(SCR2)",    "$31'1.1(SCR2)", "", "$20'1.2($00'1.2)(SCL2)", "",
                        "$21'1.2($01'1.2)(SCR2)", "", "$20'1.2($00'1.2)(SCL2)", "",    "", "", "($20'1.2)($00'1.2)(SCR2)", "",
                        "($20'1.2)($00'1.2) ", "", "$10", "$11",    "$10", "$11", "$10", "",
                        "$11", "$10",    "$11", "$10", "$11",
                    });
                }
                NRArea1();
                if (InBeat(392))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 7, new string[]
                    {
                        ...
                        //1
                        "!!3", "$1(BugLine)(<0.5,1>Drum)", "$11", "$1",    "!!3", "$11(<0.5,1>Drum)", "$1", "$11",
                        "!!3", "d(<0.5,1>Drum)", "+01", "d",    "!!3", "+01(<0.5,1>Drum)", "d", "+01",
                        "!!3", "d(<0.5,1>Drum)", "+01", "d",    "!!3", "+01(<0.5,1>Drum)", "d", "+01",
                        "!!3", "d(<0.5,1>Drum)", "+01", "d",    "!!3", "+01(<0.5,1>Drum)", "+0", "+0", 

                        //2
                        "!!3", "D(<0.5,-1>Drum)", "+10", "+10",    "!!3", "+10(<0.5,-1>Drum)", "+10", "+10",
                        "!!3", "+10(<0.5,-1>Drum)", "+10", "+10",    "!!3", "+10(<0.5,-1>Drum)", "+10", "+10",
                        "!!3", "+10(<0.5,-1>Drum)(BugLine2)", "+10", "+10",    "!!3", "+10(<0.5,-1>Drum)", "+10", "+10",
                        "!!3", "+10(<0.5,-1>Drum)", "+10", "+10",    "!!3", "+10(<0.5,-1>Drum)", "", "",

                        //3
                        "!!3", "d1(<0.5,1>Drum)(CrossLine)", "+00", "d1",    "!!3", "+00(<0.5,1>Drum)", "d1", "+00",
                        "!!3", "d1(<0.5,1>Drum)", "+00", "d1",    "!!3", "+00(<0.5,1>Drum)", "d1", "+00",
                        "!!3", "d1(<0.5,1>Drum)", "+00", "d1",    "!!3", "+00(<0.5,1>Drum)", "d1", "+00",
                        "!!3", "d1(<0.5,1>Drum)", "+00", "d1",    "!!3", "+00(<0.5,1>Drum)", "d1", "+01",  

                        //4
                        "!!3", "D1(<0.5,-1>Drum)", "+11", "+11",    "!!3", "+11(<0.5,-1>Drum)", "+11", "+11",
                        "!!3", "+11(<0.5,-1>Drum)", "+11", "+11",    "!!3", "+11(<0.5,-1>Drum)", "+11", "+11",
                        "!!3", "+11(<0.5,-1>Drum)", "+11", "+11",    "!!3", "+11(<0.5,-1>Drum)", "+11", "+11",
                        "!!3", "+11(<0.5,-1>Drum)", "+11", "+11",    "+11(<0.5,-1>Drum)"
                    });
                }
                if (InBeat(424))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 7, new string[]
                    {
                        ...
                        //4
                        "(^d'1.6)(^+21'1.6)(QuickKick)(<0.4,-1>Drum)", "", "", "",    "(^d'1.6)(^+21'1.6)(<0.4,1>Drum)", "", "", "",
                        "(^d'1.6)(^+21'1.6)(<0.4,-1>Drum)", "", "", "",    "(^d'1.6)(^+21'1.6)(<0.4,1>Drum)", "", "", "",
                        "(^d'1.6)(^+21'1.6)(<1.9,-5>Drum)", "", "", "",    "", "", "", "",
                        "(<0>SetScreenAngle)", "", "", "",    "", "", "", "",
                ...
                if (InBeat(584))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 7f, new string[]
                    {
                        ...
                        "+2", "","(d)(+01)", "",   "+0", "","(d)(+01)", "",
                        "+0", "", "+21", "",    "(d)(+21)", "", "+0", "",
                        "(^$0'1.4)($21'1.4)", "", "$21'1.5", "$0'1.5",    "$21'1.5", "", "$0'1.5", "",
                    });
                }
                if (InBeat(616))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 8f, new string[]
                    {
                        ...
                        "($0)($21)", "", "($0)($21)", "",    "($2)($01)", "", "($2)($01)", "",
                        "($3)($31)", "", "($3)($31)", "($1)($11)",    "($3)($31)", "", "($3)($31)", "",
                        "($2)($01)", "", "($2)($01)", "",    "($0)($21)", "", "($0)($21)", "",
                        "*$21", "", "*$21", "",    "*$0", "", "*$0", "",

                        "($2)($01)", "", "($2)($01)", "",    "($0)($21)", "", "($0)($21)", "",
                        "($0)($21)", "($3)($31)",    "($1)($11)", "",    "($0)($21)", "", "($0)($21)", "",
                        "($0)($21)", "", "($0)($21)", "",    "($2)($01)", "", "($2)($01)", "",
                        "(*$0)", "", "(*$0)", "",    "(*$21)", "", "(*$21)", "",
                ...
                if (InBeat(648))
                {
                    CreateChart(BeatTime(4), BeatTime(2), 8f, new string[]
                    {
                       ...
                       "!!6/3", "($31)($31)", "$1", "$1",    "$1", "",    "$1", "", "", "",
                        ...
                        "(^$00'1.6)(^$21'1.6)", "", "(^$00'1.6)(^$21'1.6)", "",    "(^$00'1.6)(^$21'1.6)", "", "(^#2.3#$00'1.6)(^#1#$21'1.6)", "",
                        "", "", "", "",    "", "", "$2", "$2",
                        "$2", "", "", "",    "", "", "", "",
                ...
                if (InBeat(680))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 8f, new string[]
                    {
                        ...
                        "$0@A", "+00@B", "+10@A", "+00@B",    "+10@A", "+00@B", "+10@A", "+00@B",
                        "+11@A", "+01@B", "+11@A", "+01@B",    "+11@A", "+01@B", "+11@A", "+01@B",
            ...
            private void NRBuildup()
            {
                if (InBeat(72))
                {
                    ...
                    {   //10
                        "$0(LoadA)","+0","+1","+0",    "+1","+0","+1","+0",
                        "+01(LoadB)","+01","+11","+01",   "+11","+01","+11","+01",
                        //11
                        ...
                        "d1","","","",    "","","","",
                        //15
                        "(Step)(KickB1)(Bound)(d)(+0)(+01)(winder)","","","",    "","","","",
                        "(d)(+0)","","","",    "","","","",
                ...
                if (InBeat(72 + 64))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 7, new string[]
                    {
                        ...
                        "(d)(+01)(LineGA)", "", "", "",    "d", "", "", "",
                        //7
                        "(d1)(+0)(LineGB1)(LineGA2)(Eff1)", "", "+1", "",    "+1", "", "+1", "",
                        "-1", "", "-1", "",    "-1", "", "-1", "",
                        "(d)(LineGB2)", "", "+11", "",    "+11", "", "+11", "",
                        "-11", "", "-11", "",    "-11", "", "-11", "",
                        //8 
                        "n01(LineGC)(Rotate)", "+0", "-01", "+0",    "-11", "+0", "-01", "+0",
                        "$31(LineGC)", "$30", "$31", "$30",    "$11", "$10", "$11", "$10",
            ...
            private void NRFinal()
            {
                if (InBeat(927))
                {
                    ...
                    RegisterFunctionOnce("BoneWall3", () =>
                    {
                        for (int i = 0; i < 4; i += 2)
                        {
                            RightBone b = new(false, i * (-16) - 10, 12.0f, 188);
                            b.ColorType = 2;
                        ...
                        for (int i = 1; i < 4; i += 2)
                        {
                            LeftBone b = new(false, i * (-16) - 10, 12.0f, 188);
                            b.ColorType = 2;
                            b.LengthLerpScale = 0.1237f;
                            CreateBone(b);
                        }
                    ...
                    RegisterFunctionOnce("MoreBone", () =>
                    {
                        ...
                        DelayBeat(2.75f, () =>
                        {
                            lbones.ForEach(s => { s.MissionLength = 90f; s.MarkScore = false; });
                            rbones.ForEach(s => { s.MissionLength = 90f; s.MarkScore = false; });
                        });
                    });
                    ...
                    RegisterFunctionOnce("BoneMid", () =>
                    {
                        for (int i = 0; i < 3; i++)
                        {
                            LeftBone b = new(false, i * -16, 15, 34 + i * 11);
                            b.LengthLerpScale = 0.1537f;
                            CreateBone(b);
                        }
                        for (int i = 0; i < 3; i++)
                        {
                            RightBone b = new(false, i * -16, 15, 34 + i * 11);
                            b.LengthLerpScale = 0.1537f;
                            CreateBone(b);
                        }
                    });
                    RegisterFunctionOnce("BoneLeft", () =>
                    {
                        for (int i = 0; i < 2; i++)
                        {
                            LeftBone b = new(false, i * -16, 15, 80);
                            b.LengthLerpScale = 0.1537f;
                            CreateBone(b);
                        }
                    });
                    RegisterFunctionOnce("BoneRight", () =>
                    {
                        for (int i = 0; i < 2; i++)
                        {
                            RightBone b = new(false, i * -16, 15, 80);
                            b.LengthLerpScale = 0.1537f;
                            CreateBone(b);
                        }
                    });
                ...
                if (InBeat(959))
                {
                    ...
                    CreateChart(0, BeatTime(2), 7.4f, new string[]
                    {
                        ...
                        "*A31@LN2", "", "*A4@LN1+", "",     "*A1@LN1", "", "*A2",    "!!12/3", "", "", "",
                        "*A41@LN1(*A2@LN2)", "", "", "",     "(*A21@LN1)(*A41@LN1)", "", "(Eff)",    "!!12/3", "", "", "*A3@LN1",
                        "A4@LN1", "", "", "",     "(*A2)(*A4)", "", "(*A2)(*A4)", "",
                    });
                }
                if (InBeat(956 + 16))
                {
                    ...
                    string s = "((*^$00'1.7)(*^$21'1.7))";
                    string s1 = "($10)($31)";
                    string s11 = "($10@A)($31@A)";
                    string s2 = "($11)($30)";
