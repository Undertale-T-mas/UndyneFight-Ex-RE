        ...
        class Project : WaveConstructor, IWaveSet
        {
            ...
            public void Extreme()
            {
                ...
                if (InBeat(4 * 16))
                {
                    ...
                    {
                        Line l1 = new(Stable(BeatTime(3), new Vector2(320 + Arguments[0] * Rand(60, 260) - 16, 240)), Stable(BeatTime(2), 90)) { Alpha = 0.8f };
                        Line l2 = new(Stable(BeatTime(3), new Vector2(320 + Arguments[0] * LastRand + 16, 240)), Stable(BeatTime(2), 90)) { Alpha = 0.8f };
                        Line[] lines = { l1, l2 };
                        for (int i = 0; i < 2; i++)
                        {
                            DelayBeat(i * 0.5f, () =>
                            {
                                ...
                                {
                                    CreateEntity(line);
                                    line.AlphaDecrease(BeatTime(3), 0.8f);
                ...
                if (InBeat(4 * 32))
                {
                    ...
                    {
                        Line l = new(EaseOut(BeatTime(1.2f), new Vector2(680, 240), new Vector2(-40, 240), EaseState.Quint),
                            Stable(BeatTime(1.2f), 90))
                        { Alpha = 0.72f };
                        CreateEntity   (l);
                        DelayBeat(1.2f, () => { l.Dispose(); });
                        ScreenDrawing.CameraEffect.Convulse(0.8f, BeatTime(0.8f), true);
                        ScreenDrawing.CameraEffect.SizeShrink(1.12f,BeatTime(0.8f));
                    });
                    RegisterFunctionOnce("LineA2", () =>
                    {
                        Line l = new(EaseOut(BeatTime(1.2f), new Vector2(-40, 240), new Vector2(680, 240), EaseState.Quint),
                            Stable(BeatTime(1.2f), 90))
                        { Alpha = 0.72f };
                        CreateEntity(l);
                        DelayBeat(1.2f, () => { l.Dispose(); });
                        ScreenDrawing.CameraEffect.Convulse(0.8f, BeatTime(0.8f), false);
                        ScreenDrawing.CameraEffect.SizeShrink(1.12f, BeatTime(0.8f));
                    });
                    RegisterFunctionOnce("LineB1", () =>
                    {
                        Line l=new(EaseOut(BeatTime(1.6f),new Vector2(320,240),new Vector2(320,-20),EaseState.Quad),
                            Stable(BeatTime(1.6f),0)){Alpha=0.72f};
                        CreateEntity(l);
                        DelayBeat(1.6f, () => { l.Dispose(); });
                    });
                    RegisterFunctionOnce("LineB2", () =>
                    {
                        Line l = new(EaseOut(BeatTime(1.6f), new Vector2(320, 240), new Vector2(320, 500), EaseState.Quad),
                            Stable(BeatTime(1.6f), 0))
                        { Alpha = 0.72f };
                        CreateEntity(l);
                        DelayBeat(1.6f, () => { l.Dispose(); });
                    });
                    ...
                    RegisterFunctionOnce("end", () =>
                    {
                        RunEase(s => InstantSetBox(s, 84, 84),
                            LinkEase(EaseOut(BeatTime(4), new Vector2(320, 240), new Vector2(240, 240), EaseState.Quad),
                            EaseIn(BeatTime(3), new Vector2(240, 240), new Vector2(240, 640), EaseState.Cubic),
                            Linear(2, new Vector2(240, 640), new Vector2(320, 240)),
                            Stable(BeatTime(1), new Vector2(240, 640))
                            ));
                        RunEase(s => InstantTP(s),
                            LinkEase(EaseOut(BeatTime(4), new Vector2(320, 240), new Vector2(240, 240), EaseState.Quad),
                            EaseIn(BeatTime(3), new Vector2(240, 240), new Vector2(240, 640), EaseState.Cubic),
                            Linear(2, new Vector2(240, 640), new Vector2(320, 240)),
                            Stable(BeatTime(1), new Vector2(240, 640))
                    ...
                    {
                        DrawingUtil.BetterBlackScreen(BeatTime(2), BeatTime(1.95f), 0, Color.Black);
                    });
                    CreateChart(BeatTime(4), BeatTime(1), 7, new string[]
                    {
                        "(#0.3#d)(LineA1)","","","",    "(+01)","","","",    "(#0.3#d)(LineA1)","","","",    "(+01)","","","",
                        "(#0.3#d)(LineA1)","","","",    "(+01)","","","",    "(#0.3#d)(LineA1)","","","",    "(+01)","","","",
                        //
                        "(#0.3#d)(LineA1)","","","",    "(+01)","","","",    "(#0.3#d)(LineA1)","","","",    "(+01)","","","",
                        "(#0.3#d)(LineA1)","","","",    "(+01)","","","",    "(#0.3#d)(LineA1)","","","",    "(+01)","","","",
                        ...
                        "$3","","","",    "","","","",    "($1)($1)","","","",    "","","","",
                        ////16
                        "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",    "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",
                        "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",    "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",
                        //
                        "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",    "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",
                        "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",    "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",
                        ...
                        "(#1.7#$1)","","","",    "","","","",    "$31","","","",    "","","","",
                        ////32
                        "(#1.3#$21)(#1.3#$3)(LineA2)(LineB1)","","","",    "","","","",    "","","","",    "(#1.3#$21)(#1.3#$0)(LineA1)(LineB2)","","","",
                        "","","","",    "","","","",    "(#1.3#$11)(#1.3#$0)(LineA1)(LineB1)","","","",    "","","","",
                        //
                        "","","","",    "(#1.3#$01)(#1.3#$0)(LineA2)(LineB2)","","","",    "+01","","","",    "","","","",
                        "+0","","","",    "","","","",    "","","","",    "","","","",
                        //
                        "(#1.7#$1)","","","",    "","","","",    "$21","","","",    "","","","",
                        "(#1.7#$11)","","","",    "","","","",    "$0","","","",    "","","","",
                        ...
                        "(+01)(+01)","","","",    "","","","",    "(+2)(+0)","","","",    "","","","",
                        ////48
                        "(#0.3#d1)(LineA1)","","","",    "(+0)","","","",    "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",
                        "(#0.3#d1)(LineA1)","","","",    "(+0)","","","",    "(#0.3#d1)(LineA2)","","","",    "(+0)","","","",
                        //
                        "$01(SizeUp)","","","",    "$2(SizeUp)","","","",    "$31(SizeUp)","","","",    "$3(SizeUp)","","","",
                        "($01)($01)(SizeUp)","","","",    "($2)($2)(SizeUp)","","","",    "($31)($31)(SizeUp)","","","",    "($3)($3)(SizeUp)","","","",
                        //
                        "(#4#$01)(Back)(end)","","","",    "","","","",    "","","","",    "","","","",
                        "","","","",    "","","","",    "","","","",    "","","","",
                        //
                ...
                if (InBeat(4 * 64))
                {
                    ...
                    {
                        RunEase((s) => { Line l = new(240, 0) { Alpha = 0.8f, Width = s, DrawingColor=Color.Red }; 
                            CreateEntity(l); DelayBeat(0.01f, () => { l.Dispose(); }); ScreenDrawing.BackGroundColor = Color.Red * s * 0.01f;
                         },
                            EaseOut(BeatTime(1.5f), 60, 0, EaseState.Quad));
                    });
                    RegisterFunctionOnce("Move", () =>
                    {
                        SetBox(new Vector2(-80, 240), 84, 84);
                        TP(new Vector2(-80, 240));
                        DelayBeat(2, () =>
                        {
                            InstantTP(new Vector2(320, -80));
                            InstantSetBox(new Vector2(320, -80), 84, 84);
                            RunEase((s) =>
                            {
                                InstantTP(s);
                                InstantSetBox(s, 84, 84);
                            }, LinkEase(EaseOut(BeatTime(2), new Vector2(320, -80), new Vector2(320, 240), EaseState.Quad), Stable(1, new Vector2(320, 240))));
                        });
                    });
                    CreateChart(BeatTime(4), BeatTime(1), 7, new string[]
                    {
                        ...
                        "","","","",    "d1","","","",    "(*+01)(+1)","","","",    "","","","",
                        //
                        "($2)($01)","","","",    "*+01","","","",    "*$3'1.4","","*$31'1.4","",    "*$3'1.4","","*$31'1.4","",
                        "*$3'1.4","","","",    "","","","",    "($21)($0)","","","",    "","","","",
                        ////16
                        "(d1)(+2)","","","",    "","","","",    "(d1)(-1)","","","",    "*+0","","","",
                        "","","","",    "(d)(-11)","","","",    "*+01","","","",    "","","","",
                        ...
                        "","","","",    "d1","","","",    "(*+01)(-1)","","","",    "","","","",
                        //
                        "($01)($2)","","","",    "*+0","","","",    "*$31'1.4","","*$3'1.4","",    "*$31'1.4","","*$3'1.4","",
                        "*$31'1.4","","","",    "","","","",    "($21)($0)","","","",    "","","","",
                        ////48
                        "(d1)(+2)","","","",    "","","","",    "(d1)(+1)","","","",    "*+0","","","",
                        "","","","",    "(d)(+11)","","","",    "*+01","","","",    "","","","",
                ...
                if (InBeat(4 * 123))
                {
                    CreateChart(BeatTime(4), BeatTime(1), 7, new string[]
                    {
                        ...
                        //
                        "*$11","","","",    "(*$21)(*$0)","","*$11","",    "(*$21)(*$0)","","","",    "*$1","","","",
                        "(*$01)(*$2)","","","",    "(*$01)(*$2)","","","",    "*$3'1.4","","*$31'1.4","",    "*$3'1.4","","*$31'1.4","",
                        //
                        ...
                        //
                        "*$1","","","",    "(*$0)(*$21)","","$1","",    "(*$0)(*$21)","","","",    "*$11","","","",
                        "(*$01)(*$2)","","","",    "(*$01)(*$2)","","","",    "*$31'1.4","","*$3'1.4","",    "*$31'1.4","","*$3'1.4","",
                        //
                ...
                if (InBeat(4 * 139))
                {
                    CreateChart(BeatTime(4), BeatTime(1), 7, new string[]
                    {
                        "$2'1.4","","$31'1.4","",    "*$2'1.4","","*$31'1.4","",    "*$2'1.4","","*$31'1.4","",    "*$2'1.4","","*$31'1.4","",
                        "*$2'1.4","","*$31'1.4","",    "*$2'1.4","","*$31'1.4","",    "*$2'1.4","","*$01'1.4","",    "*$2'1.4","","*$01'1.4","",
                        //
                        "*$2'1.4","","*$01'1.4","",    "*$2'1.4","","*$01'1.4","",    "*$2'1.4","","*$01'1.4","",    "*$2'1.4","","*$01'1.4","",
                        "*$2'1.4","","*$01'1.4","",    "*$2'1.4","","*$01'1.4","",    "*$2'1.4","","*$01'1.4","",    "*$2'1.4","","*$01'1.4","",
                        //
                        "*$1'1.4","","*$01'1.4","",    "*$1'1.4","","*$01'1.4","",    "*$1'1.4","","*$01'1.4","",    "*$1'1.4","","*$01'1.4","",
                        "*$1'1.4","","*$01'1.4","",    "*$1'1.4","","*$01'1.4","",    "*$1'1.4","","","",    "+0","","","",
                        //
                        "(+0)(d1)","","","",    "d1","","","",    "(+01)(d)","","","",    "d","","","",
                        "(+0)(d1)","","","",    "d1","","","",    "($01)($2)","","","",    "","","","",
                        ////16
