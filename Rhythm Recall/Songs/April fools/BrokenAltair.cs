...
{
    public class BrokenAltair : IChampionShip
    {
        public BrokenAltair()
        {
            difficulties = new();
            ...
            difficulties.Add("MASTER", Difficulty.ExtremePlus);
        }
        ...
        public class Game : WaveConstructor, IWaveSet
        {
            ...
            public string Music => "Broken Altair";
            ...
            private class ThisInformation : SongInformation
            {
                ...
                public override string PaintAuthor => "Kry.exe";
                public override string SongAuthor => "Kry.exe";
            }
            ...
            RenderProduction production1, production3;
            RenderProduction production2, grayProduction;
            ...
            {
                if (InBeat(0)) Part01();
                if (InBeat(17 * 4)) Part02();
                if (InBeat(41 * 4)) Part03();
                if (InBeat(49 * 4)) Part04();
            }
            public void Start()
            {
                game = this;
                ...
                SetGreenBox();
                HeartAttribute.MaxHP = 78;
                HeartAttribute.KRDamage = 2.5f;
