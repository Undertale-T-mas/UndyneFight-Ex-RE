            ...
            public void Normal()
            {
                ...
                if (InBeat(72 + 128))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 6.5f, new string[]
                    {
                        ...
                        "d1(LineL)", "", "+01", "",    "(d1)(+01)(SCS)(LineL)", "", "+01", "",
                        "(d1)(+01)(LineL)", "", "+01", "",    "(d1)(+01)(SCS)(LineL)", "", "+01", "",
                        "(d1)(+01)(LineL)", "", "+01", "",    "(d1)(+01)(SCS)(TurnR)", "", "+01", "",    
                        //6
                        "(d)(+0)", "", "", "",    "(d)(+0)(SCS)(LineR)", "", "+0", "",
                        "d(LineR)", "", "+0", "",    "(d)(+0)(SCS)(LineR)", "", "", "",
                        "(d)(+0)(LineR)", "", "+0", "",    "(d)(+0)(SCS)(LineR)", "", "+0", "",
                        "(d)(+0)(LineR)", "", "+0", "",    "(d)(+0)(SCS)(TurnL)", "", "+0", "",      
                        //7
                        "*^$0'1.3(*^$2'1.3)(Eff1)", "", "", "",    "(d)(+0)(SCS)(SCL)(LineG2)", "", "+0", "",
                        "d(LineR)", "", "+0", "",    "(d)(+0)(SCS)(SCR)(LineG1)", "", "+0", "",
                        "d(LineL)", "", "+0", "",    "(d)(+0)(SCS)(SCL)(LineG2)", "", "+0", "",
                        "d(LineR)", "", "+0", "",    "(d)(+0)(SCS)(SCR)(LineG1)", "", "n3", "",    
                        //8
                        "$1($11)(SCS-G)", "", "$1", "$1",    "$3($31)", "", "$3", "",
                        "$11($1)", "", "$11", "$11",    "$11", "", "$11", "",
                        "(D)(+01)", "", "(D)(+01)", "",    "(D)(+01)", "", "(D)(+01)", "",
                        "(D)(+01)", "", "", "",    "", "", "", "",
                    });
                ...
                if (InBeat(72 + 192))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 6.7f, new string[]
                    {
                        ...
                        "", "", "", "",    "(pre)", "", "", "",    
                        //1
                        "($2)(+0)(ROTL)", "$2", "$20", "$20",     "($0)(+0)", "$0", "$00", "$00",
                        "($3)(+0)", "", "($0)(+0)", "$00",    "$00", "", "($3)(+0)", "",
                        "$3(ML)", "", "($1)(+0)", "$1",    "$1", "", "($1)(+0)", "$1",
                        "$1", "", "($3)(+0)", "$3",    "$3", "", "", "",     
                        //2
                        "($11)(+01)(ROTR)", "", "$31", "",    "($21)(+01)", "$21", "($0)(+0)", "$0",
                        "($11)(+01)", "$11", "$11", "",    "($21)(+01)", "", "$21", "",
                        "($31)(+01)(MR)", "", "($2)(+0)", "$2",    "$2", "", "($01)(+01)", "",
                        "($11)(+01)", "", "($01)(+01)", "$01",    "$01", "", "$31", "",      
                        //3
                        ...
                        "$2(SCR)", "", "$0", "$0",    "$0(SCS)", "", "", "",    
                        //8
                        "$20'1.2($20'1.2)(SCL2)", "", "$31'1.1(SCR2)", "$31'1.1(SCR2)",    "$31'1.1(SCR2)", "", "$20'1.2($20'1.2)(SCL2)", "",
                        "$0'1.2($0'1.2)(SCR2)", "", "$20'1.2($20'1.2)(SCL2)", "",    "", "", "($30'1.2)($30'1.2)(SCR2)", "",
                        "($30'1.2)($30'1.2) ", "", "$10", "$11",    "$10", "$11", "$10", "",
                        "$11", "$10",    "$11", "$10", "$11",
                    });
                }
                NRArea1();
            ...
            private void NRBuildup()
            {
                ...
                if (InBeat(72 + 64))
                {
                    ...
                    CreateChart(BeatTime(4), BeatTime(2), 7, new string[]
                    {
                        ...
                        "(d)(+01)(LineGA)", "", "", "",    "+2", "", "", "",
                        //7
                        "(d1)(+0)(LineGB1)(LineGA2)(Eff1)", "", "+0", "",    "+1", "", "+0", "",
                        "-1", "", "-0", "",    "-1", "", "-0", "",
                        "(d)(LineGB2)", "", "+01", "",    "+11", "", "+01", "",
                        "-11", "", "-01", "",    "-11", "", "-01", "",
                        //8 
                        "(d)(+01)(LineGC)(Rotate)", "+0", "-01", "+0",    "(-11)(+0)", "+0", "-01", "+0",
                        "$31($30)(LineGC)", "$30", "$31", "$30",    "$11($10)", "$10", "$11", "$10",
                        "(^$00'1.3)(^$20'1.3)(LineGD1)", "", "", "",    "", "", "$10(LineGD2)", "",
                        "$30", "", "", "",    "", "", "", "",
                    });
                }
            }
            ...
            private void NRFinal()
            {
                ...
                if (InBeat(927.5f))
                {
                    ...
                    DelayBeat(64, () =>
                    {
                        ...
                        for (int i = 0; i < 1600; i++)
                        {
                            ...
                            {
                                rand -= 5f / 1600;
                                float x = Rand(rand * -1, rand);
                                float x2 = Rand(rand * -1, rand);
                                ScreenDrawing.ScreenPositionDetla = new Vector2(x, x2);
                                Shaders.StepSample.CentreX = x + 320;
                                Shaders.StepSample.CentreY = x2 + 240;
                            });
                    ...
                    FightResources.Shaders.DislocationX.Intensity = 5;
                    FightResources.Shaders.DislocationX.RGBSplitEnabled = true;
                    FightResources.Shaders.DislocationX.ChunkHeight = 30;
                    FightResources.Shaders.DislocationX.Speed = 200;
                    FightResources.Shaders.DislocationX.Time = 1;
                    ...
                    CreateChart(0, BeatTime(2), 15.4f, new string[]
                    {
                        ...
                        "(s)(MoveL)(BoneMid2)", "", "", "",    "(s)(MoveR)(BoneWallX)", "", "", "",
                ...
                if (InBeat(959))
                {
                    ...
                    CreateChart(0, BeatTime(2), 7.4f, new string[]
                    {
                        ...
                        "A41@LN1(A2@LN2)", "", "", "",     "(A41@LN1)(A41@LN1)", "", "(Eff)",    "!!12/3", "", "", "A3@LN1",
