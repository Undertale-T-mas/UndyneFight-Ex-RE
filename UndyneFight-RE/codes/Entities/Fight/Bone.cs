...
namespace UndyneFight_RE.codes.Entities.Fight
{
   /* public class Bone : BulletShotable
    {
        ...
        public void GetCollide(Player.Heart Heart)
        {
            ...
            float res = Max(MathF.Abs(dist) - 4.5f, MathUtil.GetDistance(Heart.Centre, Centre) - Length / 2f - 3.5f);
        ...
        protected override float GetDistance(Heart heart)
        {
            throw new NotImplementedException();
        }
